...
Die Teilnehmer:innen wissen, dass die Data Ingestion der Übernahme der Daten aus den Source Systemen dient und damit auch eine Verantwortungsübernahme verbunden ist. Sie verstehen, dass mittels Data Ingestion eine Entkoppelung zwischen Source Systemen und analytischer Verarbeitung ermöglicht wird.
