...
Den Teilnehmer:innen sind die Verfahren zur Batch- und Stream-Verarbeitung bekannt. Ihnen ist bewusst, wie Batch Verfahren durch zeitliche oder größen-basierte Pakete aus einem Streaming Umfeld erstellt werden können.
