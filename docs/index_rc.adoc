...
image:https://img.shields.io/github/commits-since/isaqb-org/curriculum-data/latest.svg[]
|===
| Version | HTML | PDF
...
- link:https://github.com/isaqb-org/curriculum-data/blob/main/CHANGELOG.md[CHANGELOG.md on GitHub]
