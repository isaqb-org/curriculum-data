...
Die Teilnehmer:innen kennen typische Beispiele für analytische Anwendungen, insbesondere aus dem Bereich Business Intelligence wie etwa Messung der Kundenzufriedenheit, Datenvisualisierung, IoT Analytics sowie Fraud Detection und Compliance-Prüfungen und können Typen von deren Nutzern unterscheiden.
