...
Den Teilnehmer:innen ist bewusst, dass die Tätigkeiten der jeweiligen Rollen von der Effektivität und Professionalität der jeweiligen Organisationen im Hinblick auf die Arbeit mit Daten abhängen.
