...
Den Teilnehmer:innen ist bewußt, dass Referenzarchitekturen begleitend zu diesen Phasen auch die folgenden Querschnittsthemen mit geeigneten Komponenten abdecken müssen:
