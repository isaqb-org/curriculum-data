...
Die Teilnehmer:innen wissen, dass Data Warehouses und Data Lakes Ansätze sind um Daten aus verschiedenen Quellsystemen zusammenführen um einen vereinheitlichten Zugriff auf diese Daten bieten zu können. Sie wissen, dass die beiden Ansätze für OLAP Anwendungen optimiert sind.
