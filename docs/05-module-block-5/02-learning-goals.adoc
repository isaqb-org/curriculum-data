...
Die Teilnehmer:innen wissen, dass Data Warehouses und Data Lakes Daten aus verschiedenen Speichersystemen zusammenführen, einen einheitliche Zugriff auf diese Daten bieten und für OLAP-basierte Zugriffsmuster optimiert sind.
