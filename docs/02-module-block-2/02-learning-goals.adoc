...
Die Teilnehmer:innen verstehen, dass Referenzarchitekturen sowohl mit monolithischen als auch mit verteilten Ansätzen wie Data Mesh umgesetzt werden können.
