...
Die Teilnehmer:innen wissen, dass die Eigenschaft der Häufigkeit der Übertragung für einen Stream eine große Rolle spielt. Sie wissen, dass die Idempotenz bei der Verarbeitung der Optimalfall ist.
