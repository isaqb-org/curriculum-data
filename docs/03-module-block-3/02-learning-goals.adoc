...
Die Die Teilnehmer:innen kennen Open-Table-Formate als Alternative zu traditionellen, monolithischen Datenbankmanagementsystemen.
...
Den Teilnehmer:innen sind die Möglichkeiten hinsichtlich Metadaten für Kategorisierung und Verwaltung, sowie einer flexiblen Verwaltung von Zugriffsberechtigungen bewusst. 
