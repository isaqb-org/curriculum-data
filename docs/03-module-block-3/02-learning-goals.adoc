...
Den Teilnehmer:innen ist bewusst, das APIs dazu dienen das interne Datenmodell zu abstrahieren und kennen zentrale Aspekte beim Entwurf von APIs wie Versioerung und Schemata.

Den Teilnehmer:innen kennen unterschiedliche Arten von APIs gibt wie beispielsweise REST, GRAPHQL und RPC.


[[LZ-3-3]]
==== LZ 3-3 - Eigenschaften von Datenbanksysteme
...
[[LZ-3-4]]
==== LZ 3-4 - Eigenschaften von Dateisystemen
