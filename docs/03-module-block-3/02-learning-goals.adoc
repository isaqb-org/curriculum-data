...
Den Teilnehmer:innen ist bewusst, dass Daten mehrfach gesendet werden können. Sie wissen, dass bei der Verarbeitung auf Idempotenz geachtet werden sollte und kennen Patterns wie dies umgesetzt werden kann.
