...
Den Teilnehmer:innen kennen unterschiedliche Ansätze von APIs wie beispielsweise REST, GRAPHQL und RPC, sowie Ansätze für reverse APIs wie beispielsweise Webhooks. 
