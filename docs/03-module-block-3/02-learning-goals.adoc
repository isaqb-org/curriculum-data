...
[[LZ-3-6]]
==== LZ 3-6 - Eigenschaften von Blockspeicher
Die Teilnehmer:innen wissen, dass der Speicherplatz bei Blockspeichern in Blöcke fester Größe eingeteilt ist.

Die Teilnehmer:innen kennen Beispiele für Object Stores für den Cloud und on-Premise Betrieb. 


[[LZ-3-7]]
==== LZ 3-7 - Eigenschaften von Object Stores
