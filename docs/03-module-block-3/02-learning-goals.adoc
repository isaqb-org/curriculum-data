...
Den Teilnehmer:innen ist bewusst, dass Daten mehrfach gesendet werden können, da es aufwendig ist sicherzustellen, dass Daten tatsächlich verarbeitet wurden. Sie kennen die Vorteile einer idempotenten Verarbeitung.
