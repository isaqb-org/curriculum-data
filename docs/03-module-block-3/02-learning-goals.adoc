...
Den Teilnehmer:innen sind die Möglichkeiten hinsichtlich Metadaten und Zugriffsberechtigungen bewusst aber auch mögliche Probleme hinsichtlich Nebenläufigkeit. 
